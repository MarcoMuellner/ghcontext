...
describe("README Content Retrieval", () => {
  ...
  describe("getReadmeContent", () => {
    ...
    it("should throw error for other API errors", async () => {
      ...
      // Act & Assert
      await expect(getReadmeContent("facebook", "react")).rejects.toThrow(
        "GitHub API error",
      );
  ...
  describe("getReadmeContentByPath", () => {
    it("should return cached README content if available", async () => {
      ...
      // Act
      const result = await getReadmeContentByPath(
        "facebook",
        "react",
        "docs/README.md",
      );
      ...
      expect(cache.get).toHaveBeenCalledWith(
        "readme-path:facebook/react:docs/README.md",
      );
    ...
    it("should throw error when path points to a directory, not a file", async () => {
      ...
      // Act & Assert
      await expect(
        getReadmeContentByPath("facebook", "react", "docs"),
