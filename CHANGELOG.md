...
### Changed
- Updated getRepositoryStructure to include path parameter
- Enhanced README with private repository documentation

## [1.0.1] - 2025-04-14

### Changed
- Renamed package from GitCP/github-mcp to ghcontext
- Updated all documentation to reflect name change
- Updated user agent string in GitHub client
